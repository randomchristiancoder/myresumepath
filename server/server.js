  ...
  try {
    const validation = {
      ...
      endpoints: {
        ...
        upload: { status: 'operational', method: 'POST' },
        'upload-resume': { status: 'operational', method: 'POST' },
        'validate-system': { status: 'operational', method: 'GET' },
        'job-matches': { status: 'operational', method: 'POST' },
        'course-recommendations': { status: 'operational', method: 'POST' },
        'personality-analysis': { status: 'operational', method: 'POST' },
        'generate-report': { status: 'operational', method: 'POST' }
      },
      features: {
        ...
        courseRecommendations: 'operational',
        personalityAnalysis: 'operational',
